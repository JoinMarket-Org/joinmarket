...
#i changed this 8/2014 to include this proxy thing
# that also required changing everything to http requests since the 
...
def make_request(*args):
    if __proxy_handler != None:
        opener = urllib2.build_opener(__proxy_handler)
    else:
