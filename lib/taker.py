...
class CoinJoinTX(object):
    ...
    def start_encryption(self, nick, maker_pk):
        ...
        my_btc_sig = btc.ecdsa_sign(self.kp.hex_pk(),
                                    binascii.unhexlify(my_btc_priv))
    ...
    def auth_counterparty(self, nick, btc_sig, cj_pub):
        ...
        if not btc.ecdsa_verify(self.crypto_boxes[nick][0], btc_sig,
                                binascii.unhexlify(cj_pub)):
