...
from lib.common import debug, calc_cj_fee, Wallet, debug_dump_object
from lib.blockchaininterface import BlockrInterface
from lib.maker import Maker
from lib.irc import IRCMessageChannel, random_nick
...
class YieldGenerator(Maker):
    ...
    def __init__(self, msgchan, wallet):
        super(YieldGenerator, self).__init__(self, msgchan, wallet)
    ...
    def on_welcome(self):
        super(YieldGenerator, self).on_welcome(self)
...
def main():
    ...
    seed = sys.argv[1]
    if isinstance(common.bc_interface, BlockrInterface):
